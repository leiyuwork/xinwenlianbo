...
def news(url):
    print(url)
    log_url = open(
        r"C:\Users\ray\OneDrive\Research\PHD\Research\data\context analysis\xinwenlianbo20121224-20130715\xinwenlianbo20121224-20130715-log.txt",
        'a', encoding='utf-8')
    log_url.write(url)
    log_url.write('\n')
    log_url.close()
...
def save_text(date):
    f = open(r"C:\Users\ray\OneDrive\Research\PHD\Research\data\context analysis\xinwenlianbo20121224-20130715\\" + str(date) + '.txt', 'a', encoding='utf-8')
...
for date in datelist('20121224', '20130715'):
    try:
        save_text(date)
    except:
